...
<div class="hcap-page-root">
	<header class="page-mast">
		<div>
			...
			<h1 class="page-title">Resum del torneig</h1>
		</div>
	</header>
...
<style>
	...
	.hcap-page-root :global([class*='from-yellow-']),
	.hcap-page-root :global([class*='to-amber-']) {
		background: var(--paper-elevated) !important;
	...
	.hcap-page-root :global(.text-yellow-800),
	.hcap-page-root :global(.text-yellow-900) { color: var(--amber) !important; }
