...
# Guardar script
$header | Out-File -FilePath "script_cloud_mitjanes_historiques.sql" -Encoding UTF8
$sqlInserts | Out-File -FilePath "script_cloud_mitjanes_historiques.sql" -Encoding UTF8 -Append
$footer | Out-File -FilePath "script_cloud_mitjanes_historiques.sql" -Encoding UTF8 -Append
...
Write-Host "Exsocis amb ID 00XX: $exsocis"
Write-Host "================================="