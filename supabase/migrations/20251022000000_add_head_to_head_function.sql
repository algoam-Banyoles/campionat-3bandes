-- Migration: Add head-to-head results function for social leagues
-- Date: 2025-10-22
-- Description: Creates a function to retrieve head-to-head match results for a specific category
