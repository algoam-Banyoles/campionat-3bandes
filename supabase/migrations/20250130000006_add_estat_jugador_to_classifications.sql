-- Afegir camp estat_jugador a la funció get_social_league_classifications
-- Això permet mostrar els jugadors retirats/eliminats per incompareixences
...
'Returns real-time classifications for social leagues. Utilitza entrades_jugador1/jugador2 i punts_jugador1/jugador2 per gestionar incompareixences correctament. Inclou estat_jugador per mostrar jugadors retirats. SECURITY: Uses SET search_path = public.';
