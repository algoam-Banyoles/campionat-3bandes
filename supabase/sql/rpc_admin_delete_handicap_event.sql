-- Còpia idèntica de la migració 20260521000000_admin_delete_handicap_event_rpc.sql
-- Mantingut aquí per coherència amb el patró del repo (RPCs documentades a supabase/sql/).
-- L'aplicació canònica és la migració. Aquest fitxer és per a referència manual al SQL Editor.
