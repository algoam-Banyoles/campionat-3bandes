...
BEGIN
  ...
  SELECT count(*) INTO v_notifications_history FROM notification_history;
  SELECT count(*) INTO v_scheduled_notifications FROM scheduled_notifications;
  SELECT count(*) INTO v_club_events FROM esdeveniments_club;
